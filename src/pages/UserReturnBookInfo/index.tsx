...
const UserReturnBookInfo: React.FC<AppScreenProps> = ({navigation}) => {
    ...
    <View style={styles.content}>
        ...
        {booksinfo ? (
          <>
            ...
            <View style={styles.basicinfo}>
              ...
              <Text style={styles.infotext}>{booksinfo.detail}</Text>
            </View>
            <View style={styles.basicinfo}>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Text style={styles.button}>归还</Text>
        </TouchableOpacity>
...
export default UserReturnBookInfo;
